...
public class FloralisBlocks {
	...
	public static final DeferredBlock<Block> WHITE_DYE_BLOCK = BLOCKS.register("white_dye_block", () -> new Block(FloralisBlocks.propertiesDyeBlock(MapColor.SNOW)));
	public static final DeferredBlock<Block> LIGHT_GRAY_DYE_BLOCK = BLOCKS.register("light_gray_dye_block", () -> new Block(FloralisBlocks.propertiesDyeBlock(MapColor.COLOR_LIGHT_GRAY)));
	public static final DeferredBlock<Block> GRAY_DYE_BLOCK = BLOCKS.register("gray_dye_block", () -> new Block(FloralisBlocks.propertiesDyeBlock(MapColor.COLOR_GRAY)));
	public static final DeferredBlock<Block> BLACK_DYE_BLOCK = BLOCKS.register("black_dye_block", () -> new Block(FloralisBlocks.propertiesDyeBlock(MapColor.COLOR_BLACK)));
	public static final DeferredBlock<Block> BROWN_DYE_BLOCK = BLOCKS.register("brown_dye_block", () -> new Block(FloralisBlocks.propertiesDyeBlock(MapColor.COLOR_BROWN)));
	public static final DeferredBlock<Block> RED_DYE_BLOCK = BLOCKS.register("red_dye_block", () -> new Block(FloralisBlocks.propertiesDyeBlock(MapColor.COLOR_RED)));
	public static final DeferredBlock<Block> ORANGE_DYE_BLOCK = BLOCKS.register("orange_dye_block", () -> new Block(FloralisBlocks.propertiesDyeBlock(MapColor.COLOR_ORANGE)));
	public static final DeferredBlock<Block> YELLOW_DYE_BLOCK = BLOCKS.register("yellow_dye_block", () -> new Block(FloralisBlocks.propertiesDyeBlock(MapColor.COLOR_YELLOW)));
	public static final DeferredBlock<Block> LIME_DYE_BLOCK = BLOCKS.register("lime_dye_block", () -> new Block(FloralisBlocks.propertiesDyeBlock(MapColor.COLOR_LIGHT_GREEN)));
	public static final DeferredBlock<Block> GREEN_DYE_BLOCK = BLOCKS.register("green_dye_block", () -> new Block(FloralisBlocks.propertiesDyeBlock(MapColor.COLOR_GREEN)));
	public static final DeferredBlock<Block> CYAN_DYE_BLOCK = BLOCKS.register("cyan_dye_block", () -> new Block(FloralisBlocks.propertiesDyeBlock(MapColor.COLOR_CYAN)));
	public static final DeferredBlock<Block> LIGHT_BLUE_DYE_BLOCK = BLOCKS.register("light_blue_dye_block", () -> new Block(FloralisBlocks.propertiesDyeBlock(MapColor.COLOR_LIGHT_BLUE)));
	public static final DeferredBlock<Block> BLUE_DYE_BLOCK = BLOCKS.register("blue_dye_block", () -> new Block(FloralisBlocks.propertiesDyeBlock(MapColor.COLOR_BLUE)));
	public static final DeferredBlock<Block> PURPLE_DYE_BLOCK = BLOCKS.register("purple_dye_block", () -> new Block(FloralisBlocks.propertiesDyeBlock(MapColor.COLOR_PURPLE)));
	public static final DeferredBlock<Block> MAGENTA_DYE_BLOCK = BLOCKS.register("magenta_dye_block", () -> new Block(FloralisBlocks.propertiesDyeBlock(MapColor.COLOR_MAGENTA)));
	public static final DeferredBlock<Block> PINK_DYE_BLOCK = BLOCKS.register("pink_dye_block", () -> new Block(FloralisBlocks.propertiesDyeBlock(MapColor.COLOR_PINK)));
	...
	public static final DeferredBlock<Block> WHITE_CACTUS_CROP = BLOCKS.register("white_cactus_crop", () -> new CactusCropBlock(FloralisBlocks.propertiesCrop()));
	public static final DeferredBlock<Block> LIGHT_GRAY_CACTUS_CROP = BLOCKS.register("light_gray_cactus_crop", () -> new CactusCropBlock(FloralisBlocks.propertiesCrop()));
	public static final DeferredBlock<Block> GRAY_CACTUS_CROP = BLOCKS.register("gray_cactus_crop", () -> new CactusCropBlock(FloralisBlocks.propertiesCrop()));
	public static final DeferredBlock<Block> BLACK_CACTUS_CROP = BLOCKS.register("black_cactus_crop", () -> new CactusCropBlock(FloralisBlocks.propertiesCrop()));
	public static final DeferredBlock<Block> BROWN_CACTUS_CROP = BLOCKS.register("brown_cactus_crop", () -> new CactusCropBlock(FloralisBlocks.propertiesCrop()));
	public static final DeferredBlock<Block> RED_CACTUS_CROP = BLOCKS.register("red_cactus_crop", () -> new CactusCropBlock(FloralisBlocks.propertiesCrop()));
	public static final DeferredBlock<Block> ORANGE_CACTUS_CROP = BLOCKS.register("orange_cactus_crop", () -> new CactusCropBlock(FloralisBlocks.propertiesCrop()));
	public static final DeferredBlock<Block> YELLOW_CACTUS_CROP = BLOCKS.register("yellow_cactus_crop", () -> new CactusCropBlock(FloralisBlocks.propertiesCrop()));
	public static final DeferredBlock<Block> LIME_CACTUS_CROP = BLOCKS.register("lime_cactus_crop", () -> new CactusCropBlock(FloralisBlocks.propertiesCrop()));
	public static final DeferredBlock<Block> GREEN_CACTUS_CROP = BLOCKS.register("green_cactus_crop", () -> new CactusCropBlock(FloralisBlocks.propertiesCrop()));
	public static final DeferredBlock<Block> CYAN_CACTUS_CROP = BLOCKS.register("cyan_cactus_crop", () -> new CactusCropBlock(FloralisBlocks.propertiesCrop()));
	public static final DeferredBlock<Block> LIGHT_BLUE_CACTUS_CROP = BLOCKS.register("light_blue_cactus_crop", () -> new CactusCropBlock(FloralisBlocks.propertiesCrop()));
	public static final DeferredBlock<Block> BLUE_CACTUS_CROP = BLOCKS.register("blue_cactus_crop", () -> new CactusCropBlock(FloralisBlocks.propertiesCrop()));
	public static final DeferredBlock<Block> PURPLE_CACTUS_CROP = BLOCKS.register("purple_cactus_crop", () -> new CactusCropBlock(FloralisBlocks.propertiesCrop()));
	public static final DeferredBlock<Block> MAGENTA_CACTUS_CROP = BLOCKS.register("magenta_cactus_crop", () -> new CactusCropBlock(FloralisBlocks.propertiesCrop()));
	public static final DeferredBlock<Block> PINK_CACTUS_CROP = BLOCKS.register("pink_cactus_crop", () -> new CactusCropBlock(FloralisBlocks.propertiesCrop()));
	...
	public static final DeferredBlock<Block> CLOCHED_WHITE_CACTUS_CROP = BLOCKS.register("cloched_white_cactus_crop", () -> new CactusCropBlock(FloralisBlocks.propertiesCrop()));
	public static final DeferredBlock<Block> CLOCHED_LIGHT_GRAY_CACTUS_CROP = BLOCKS.register("cloched_light_gray_cactus_crop", () -> new CactusCropBlock(FloralisBlocks.propertiesCrop()));
	public static final DeferredBlock<Block> CLOCHED_GRAY_CACTUS_CROP = BLOCKS.register("cloched_gray_cactus_crop", () -> new CactusCropBlock(FloralisBlocks.propertiesCrop()));
	public static final DeferredBlock<Block> CLOCHED_BLACK_CACTUS_CROP = BLOCKS.register("cloched_black_cactus_crop", () -> new CactusCropBlock(FloralisBlocks.propertiesCrop()));
	public static final DeferredBlock<Block> CLOCHED_BROWN_CACTUS_CROP = BLOCKS.register("cloched_brown_cactus_crop", () -> new CactusCropBlock(FloralisBlocks.propertiesCrop()));
	public static final DeferredBlock<Block> CLOCHED_RED_CACTUS_CROP = BLOCKS.register("cloched_red_cactus_crop", () -> new CactusCropBlock(FloralisBlocks.propertiesCrop()));
	public static final DeferredBlock<Block> CLOCHED_ORANGE_CACTUS_CROP = BLOCKS.register("cloched_orange_cactus_crop", () -> new CactusCropBlock(FloralisBlocks.propertiesCrop()));
	public static final DeferredBlock<Block> CLOCHED_YELLOW_CACTUS_CROP = BLOCKS.register("cloched_yellow_cactus_crop", () -> new CactusCropBlock(FloralisBlocks.propertiesCrop()));
	public static final DeferredBlock<Block> CLOCHED_LIME_CACTUS_CROP = BLOCKS.register("cloched_lime_cactus_crop", () -> new CactusCropBlock(FloralisBlocks.propertiesCrop()));
	public static final DeferredBlock<Block> CLOCHED_GREEN_CACTUS_CROP = BLOCKS.register("cloched_green_cactus_crop", () -> new CactusCropBlock(FloralisBlocks.propertiesCrop()));
	public static final DeferredBlock<Block> CLOCHED_CYAN_CACTUS_CROP = BLOCKS.register("cloched_cyan_cactus_crop", () -> new CactusCropBlock(FloralisBlocks.propertiesCrop()));
	public static final DeferredBlock<Block> CLOCHED_LIGHT_BLUE_CACTUS_CROP = BLOCKS.register("cloched_light_blue_cactus_crop", () -> new CactusCropBlock(FloralisBlocks.propertiesCrop()));
	public static final DeferredBlock<Block> CLOCHED_BLUE_CACTUS_CROP = BLOCKS.register("cloched_blue_cactus_crop", () -> new CactusCropBlock(FloralisBlocks.propertiesCrop()));
	public static final DeferredBlock<Block> CLOCHED_PURPLE_CACTUS_CROP = BLOCKS.register("cloched_purple_cactus_crop", () -> new CactusCropBlock(FloralisBlocks.propertiesCrop()));
	public static final DeferredBlock<Block> CLOCHED_MAGENTA_CACTUS_CROP = BLOCKS.register("cloched_magenta_cactus_crop", () -> new CactusCropBlock(FloralisBlocks.propertiesCrop()));
	public static final DeferredBlock<Block> CLOCHED_PINK_CACTUS_CROP = BLOCKS.register("cloched_pink_cactus_crop", () -> new CactusCropBlock(FloralisBlocks.propertiesCrop()));
